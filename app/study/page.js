  ...
  const cards = [
    {
      ...
      description: t('roadSignsDescription', 'Learn the meaning of road signs and signals'),
      href: "/road-signs",
      icon: "🚦",
    ...
    },
    {
      ...
      description: t('vehiclePartsDescription', 'Understand vehicle components and their functions'),
      href: "/vehicle-parts",
      icon: "🚗",
      gradient: "from-purple-500 to-pink-500",
      hoverGradient: "from-purple-600 to-pink-600",
      iconBg: "from-purple-100 to-pink-100 dark:from-purple-900 dark:to-pink-900"
    },
    {
      title: t('trafficLights','Traffic Lights'),
      description: t('trafficLightsDescription','Learn about traffic light signals and their meanings'),
      href: "/traffic-lights",
      icon: "🚦",
    ...
    },
    {
      ...
      description: t('roadLawsDescription', 'Explore rules and regulations that govern the road'),
      href: "/roadLaws",
      icon: "📋",
    ...
    },
    {
      ...
      description: t('safetyTrainingDescription', 'Complete training designed to keep you safe on the road'),
      href: "/roadLaws/training",
      icon: "🛡️",
      gradient: "from-indigo-500 to-blue-500",
      hoverGradient: "from-indigo-600 to-blue-600",
      iconBg: "from-indigo-100 to-blue-100 dark:from-indigo-900 dark:to-blue-900"
    },
    {
      title: t('practiceQuizzes', 'Practice Quizzes'),
      description: t('practiceQuizzesDescription', 'Test your knowledge with interactive quizzes'),
      href: "/quiz",
      icon: "📝",
      gradient: "from-yellow-500 to-orange-500",
      hoverGradient: "from-yellow-600 to-orange-600",
      iconBg: "from-yellow-100 to-orange-100 dark:from-yellow-900 dark:to-orange-900"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-20 left-10 text-2xl opacity-50 animate-bounce">📚</div>
        <div className="absolute top-40 right-20 text-xl opacity-50 animate-bounce" style={{ animationDelay: '1s' }}>🎓</div>
        <div className="absolute bottom-40 left-20 text-lg opacity-50 animate-bounce" style={{ animationDelay: '2s' }}>💡</div>
        <div className="absolute bottom-20 right-10 text-2xl opacity-50 animate-bounce" style={{ animationDelay: '3s' }}>🏆</div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8">
          ...
          {cards.map((card, index) => (
            ...
            >
              <div className="relative h-full backdrop-blur-xl bg-white/90 dark:bg-gray-900/90 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden transition-all duration-500 ease-out hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20 dark:hover:shadow-purple-500/40 hover:border-purple-400/50 dark:hover:border-purple-400/50">
                ...
                <div className={`absolute inset-0 bg-linear-to-br ${card.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500 ease-out`}></div>
                ...
                <div className="absolute top-4 right-6 w-0.5 h-0.5 bg-blue-400 rounded-full opacity-0 group-hover:opacity-60 group-hover:animate-ping transition-all duration-500 ease-out" style={{ animationDelay: '0.2s' }}></div>

                <div className="relative p-6 sm:p-8 flex flex-col h-full">
                  
                  <div className="relative mb-6">
                    <div className={`absolute inset-0 bg-linear-to-br ${card.iconBg} rounded-2xl blur opacity-0 group-hover:opacity-60 transition-opacity duration-500 ease-out`}></div>
                    <div className={`relative w-16 h-16 bg-linear-to-br ${card.iconBg} rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 ease-out`}>
                      <span className="text-3xl group-hover:scale-110 transition-transform duration-500 ease-out">
                        {card.icon}
                      </span>
                    </div>
                    
                    <div className={`absolute inset-0 bg-linear-to-br ${card.gradient} rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500 ease-out`}></div>
                  </div>
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    <div className="flex items-center text-blue-600 dark:text-blue-400 font-medium text-sm group-hover:translate-x-2 transition-transform duration-500 ease-out">
                      <span>{t('explore')}</span>
                      <svg className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-500 ease-out" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="w-8 h-1 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div className={`h-full bg-linear-to-r ${card.gradient} w-0 group-hover:w-full transition-all duration-500 ease-out`}></div>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-16 sm:mt-20 text-center animate-fade-in" style={{ animationDelay: '600ms' }}>
